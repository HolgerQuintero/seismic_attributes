...
H1=np.load(r'C:\Users\USUARIO\Documents\Python Scripts\proyecto\python\modelado\modelo_tenerife\aleatorio\gather_x_sin_rm.npy')
V1=np.load(r'C:\Users\USUARIO\Documents\Python Scripts\proyecto\python\modelado\modelo_tenerife\aleatorio\gather_z_sin_rm.npy')
H2=np.load(r'C:\Users\USUARIO\Documents\Python Scripts\proyecto\python\modelado\modelo_tenerife\aleatorio\gather_x_con_rm.npy')
V2=np.load(r'C:\Users\USUARIO\Documents\Python Scripts\proyecto\python\modelado\modelo_tenerife\aleatorio\gather_z_con_rm.npy')
...
plt.figure(1)
plt.subplot(121)
plt.imshow(Horizontal[:,:],aspect='auto',vmin=-1e-8,vmax=1e-8, extent=[x[0],x[x.shape[0]-1],t[t.shape[0]-1],t[0]],cmap=cm.gray)
...
mascara1=((H+V)>(1e-3)*np.mean(H+V))# es por defecto 1e-3
...
df1=df.iloc[:,[0,2,16,-1]] #De a 4 atributos se ve mejor
